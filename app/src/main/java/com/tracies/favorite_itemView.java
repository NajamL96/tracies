...
public class favorite_itemView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Object object = getIntent().getSerializableExtra("detailfavorite");
        favoritelistModel = (favoritelistModel)  object;
        String categoriesId = favoritelistModel.getCategoryID();
        ...
        rcv.setCurrentPageListener(new SliderView.OnSliderPageListener() {
            ...
            public void onSliderPageChanged(int position) {
                ...
                if (position == 0){
                    Log.e("load12","loads speak" + position);
                    previous.setVisibility(View.GONE);
                    next.setVisibility(View.VISIBLE);
                } else{
                    Log.e("load123","loads Things" + position);
        ...
        small_2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (model.getSmall() >= 2) {
                    ...
                    Toast.makeText(favorite_itemView.this, "Not enough items left", Toast.LENGTH_SHORT).show();
                }
...
//                item_extraLage.setBackgroundResource(round_corner_pink);
        ...
        cart1.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(favorite_itemView.this,Cart.class);
        ...
        item_shopping.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(favorite_itemView.this,Bottom_nav.class);
                startActivity(intent);
            }
        });
...
//                model.setSelected(true);
                ...
                Log.e("totalcount","" + T);
                if (T < 8){
                    Toast.makeText(favorite_itemView.this, "select minimum of 8 pieces", Toast.LENGTH_SHORT).show();
                }else {
                            ...
                            .addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                    ...
                                    if (match.equals("found")){
                                        ...
                                        Toast.makeText(favorite_itemView.this, "Sucessfully added to cart", Toast.LENGTH_SHORT).show();
